...
export default function Login() {
    ...
    return (
        <div className="flex items-center h-screen justify-center bg-linear-150 from-shade1 to-secondary py-44 md:py-36 lg:py-30 xl:py-26">

            {/* Using Alert Component here */}
            <Alert />

            <div className="flex flex-col items-center gap-5 lg:gap-7 bg-white  :rounded-lg lg:rounded-2xl px-6 py-6 lg:py-6 xl:py-8 shadow-md lg:shadow-lg xl:shadow-xl sm:w-100 lg:w-2/5 xl:w-2/6">
                ...
                <div className="flex flex-col items-center gap-3">
                    ...
                    <div className="bg-shade1/30 p-3 lg:p-5 rounded-full">
                        <LockIcon className="text-shade1 w-5 h-5 lg:w-7 lg:h-7" />
                    </div>

                    <h3 className="font-poppins text-2xl lg:text-3xl font-semibold text-secondary/90 "> Welcome Back </h3>
                ...
                <form className="flex flex-col items-start gap-3 xl:gap-4">
                    ...
                    <div className="flex flex-row items-center justify-center gap-2">
                        ...
                        <label htmlFor="userConfirm" className="text-sm font-poppins text-secondary font-semibold" > Remember Me </label>
                    </div>

                    {/* Sign Up or Login redirection towards user's page */}
                    <div className="flex flex-row items-center gap-2 lg:gap-3">
                        <button type="submit" className="px-3 text-white font-poppins font-medium text-sm lg:text-base bg-shade2 py-1 cursor-pointer lg:py-2 rounded-md lg:rounded-lg active:scale-90 ease-in duration-150" onClick={submitData}> Sign In </button>
                ...
                <div className="flex flex-row items-center gap-1 lg:gap-2">
                    ...
                    <Link to="/signup" className="text-sm cursor-pointer text-shade1 font-poppins font-semibold"> Sign Up </Link>
                </div>
